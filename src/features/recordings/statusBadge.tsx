...
const BADGE_MAP: Record<Track, Record<string, BadgeConfig>> = {
  recording: {
    ...
    draft:       { label: '초안',      icon: '○', bg: '#f0f0f0', text: '#888888', border: '#e0e0e0' },
  },
  upload: {
    not_started: { label: '업로드 대기', icon: '⏳', bg: '#f0f0f0', text: '#888888', border: '#e0e0e0' },
    queued:      { label: '업로드 예정', icon: '↑',  bg: '#f0f0f0', text: '#111111', border: '#e0e0e0' },
  ...
  transcription: {
    not_requested: { label: '변환 대기',      icon: '⏳', bg: '#f0f0f0', text: '#888888', border: '#e0e0e0' },
    ...
    cancelled:     { label: '취소됨',         icon: '○',  bg: '#f0f0f0', text: '#888888', border: '#e0e0e0' },
  },
};
...
const styles = StyleSheet.create({
  ...
  icon: { fontSize: 11, fontFamily: 'Pretendard-Medium' },
